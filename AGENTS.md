...
### 👁️ Visual Skills Installed
- **camera**: Capture photos from webcams (Brio/FaceTime)
- **vision-sandbox**: Agentic vision via Gemini's code execution sandbox
- **computer-vision-expert**: SOTA computer vision (YOLO26, SAM 3, VLMs)

### ✋ Hand Skills Installed (操作能力)
